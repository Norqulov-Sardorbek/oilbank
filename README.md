...
Ecommerce website for oilbank to book services, purchase products and leave review about quality

### Clone the repository:
```bash
git clone ssh://git@94.176.182.67:2224/car-land/oilbank_ecommerce.git
cd oilbank_ecommerce
```
...
### Creating a Database
 ...
 - Now, we shall create a database user for our database. We will call the user `postgres`. Replace `password` with a strong password below.
   ```bash
...
- **User API Endpoints**: [http://localhost:8000/user/](http://localhost:8000/api/)
